...
/* Timeout counter (adjust based on STM8 clock speed, e.g., 16 MHz) */
#define I2C_TIMEOUT 1000 /* Timeout in loops, ~1 ms at 16 MHz */

/* BME280 I2C address (shifted for STM8 I2C library: 0x76 << 1 or 0x77 << 1) */
