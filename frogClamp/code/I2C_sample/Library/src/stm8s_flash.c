...
#ifdef _COSMIC_
    *((@far u8*)Address) = BYTE_3(Data); /* Write one byte */
    *(((@far u8*)Address) + 1) = BYTE_2(Data); /* Write one byte */
    *(((@far u8*)Address) + 2) = BYTE_1(Data); /* Write one byte */
    *(((@far u8*)Address) + 3) = BYTE_0(Data); /* Write one byte */
#else
